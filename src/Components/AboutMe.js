    ...
    <div className="about-me">
      <div className="about-me-content">
        ...
        <div className="text">
          ...
          Wenn du ein Bug findest / mit programmieren willst, schau dir mein <a href="https://github.com/arcadefortune/wannistpause" className="link">GitHub</a> an<br/> <br/>
          Ich habe auch ein wunderschönes Rechtsclick-Menu gebaut :)
        </div>
      </div>
    </div>
  )
